...
class VariationalAutoEncoder(nn.Module):
    def __init__(self, device, latent_dim):
        ...
        self.flux_wl_decoder = nn.Sequential(  # [b, 2, 18, 69]
            ...
            nn.ConvTranspose2d(2, 2, kernel_size=(1, 4), stride=(1, 2), padding=(0, 1)),
            # [b, 2, 2, 1250]    # ks=(1, 4) otherwise the shape was not correct...
            nn.LeakyReLU(),
    ...
    def decode(self, z):
        # decode latent
        decoded_latent = self.latent_decoder(z)  # [b, 2, 56, 69]
